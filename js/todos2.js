...
$(function() {
  ...
  //Parse.initialize("your-application-id", "your-javascript-key");
   Parse.initialize("1mVUcS0CaYgFz523zwNRIGwAUUwdfdBwSH71xhue", 
	   "kVWAGrVe7vFSHr7xY9DSFN0KbK5stiYnkJK52KdT");
    ...
    logIn: function(e) {
      ...
      Parse.User.logIn(username, password, {
        success: function(user) {
          new ManageTodosView();  // initial screen/template after login
  ...
  var AppView = Parse.View.extend({
    ...
    render: function() {
      if (Parse.User.current()) {
        new ManageTodosView(); // first template to launch!
      } else {
        new LogInView();
      }
    }
